...
@iterate_jit(nopython=True)
def cal_shif_deduction(shif_deduction_rate, total_income,     
                           shif_deduction):
    """
    Compute social health insurance levy.
    """
    shif_deduction = (shif_deduction_rate*total_income)
    return shif_deduction

@iterate_jit(nopython=True)
def cal_total_deductions(mortgage_deduction, pension_deduction, hosp_tot_deposit_year,ahl_deduction,shif_deduction,    
                           total_deductions):
    """
    Compute total gross income.
    """
    total_deductions = mortgage_deduction+pension_deduction+hosp_tot_deposit_year+ahl_deduction+shif_deduction
...
@iterate_jit(nopython=True)
def cal_pit_w(rate1, rate2, rate3, rate4, rate5,rate6,rate7, tbrk1, tbrk2, tbrk3, tbrk4, tbrk5,tbrk6,tbrk7, income_wage_behavior, pitax_w):
    """
    Compute PIT.
    """
